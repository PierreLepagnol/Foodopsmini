...
def demo_evenements_aleatoires():
    ...
    events_by_category = {
        "🌤️ MÉTÉO": [
            ...
            {"name": "Tempête de neige", "effect": "📉 -30% demande (hiver)", "prob": "12%"}
        ],
        "💰 ÉCONOMIQUE": [
            {"name": "Crise économique", "effect": "📉 +60% sensibilité prix", "prob": "8%"},
            {"name": "Prime exceptionnelle", "effect": "📈 +20% demande", "prob": "15%"}
        ],
        "👥 SOCIAL": [
        ...
        "📦 APPROVISIONNEMENT": [
            {"name": "Pénurie viande", "effect": "⚖️ +40% importance qualité", "prob": "8%"},
            {"name": "Récolte exceptionnelle", "effect": "📈 +20% importance qualité", "prob": "20%"}
        ],
        "📋 RÉGLEMENTATION": [
            {"name": "Contrôle sanitaire", "effect": "⚖️ +50% importance qualité", "prob": "18%"},
...
def demo_gestion_strategique():
    ...
    for scenario in scenarios:
        print(f"{scenario['tour']:<6} | {scenario['event']:<25} | {scenario['strategy']:<25} | {scenario['result']:<20}")

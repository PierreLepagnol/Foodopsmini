...
class CompetitionManager:
    ...
    def _load_market_events(self) -> List[MarketEvent]:
        ...
        events = [
            ...
            MarketEvent(
                ...
                segment_impact={"familles": Decimal("1.3"), "étudiants": Decimal("1.4")},
            ...
            MarketEvent(
                ...
                segment_impact={"étudiants": Decimal("0.7"), "familles": Decimal("0.8")}
            ),
            ...
            MarketEvent(
                ...
                quality_importance_modifier=Decimal("1.3")  # Qualité devient plus importante
            ),
    ...
    def process_turn_events(self, current_turn: int, current_season: str) -> List[MarketEvent]:
        """
    ...
    def simulate_competitor_actions(self, current_turn: int, market_data: Dict) -> List[CompetitorAction]:
        """
    ...
    def get_competition_summary(self) -> Dict[str, any]:
        ...
        return {
            ...
            "recent_competitor_actions": len([
                a for a in self.competitor_actions 
    ...
    def update_competitive_pressure(self, market_performance: Dict[str, float]) -> None:
        ...
        avg_margin = sum(market_performance.values()) / len(market_performance) if market_performance else 0.15
        
        if avg_margin < 0.10:  # Marges très faibles
            self.competitive_pressure = min(Decimal("2.0"), self.competitive_pressure + Decimal("0.1"))
        elif avg_margin > 0.25:  # Marges élevées
            self.competitive_pressure = max(Decimal("0.5"), self.competitive_pressure - Decimal("0.05"))

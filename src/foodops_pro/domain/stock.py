...
class StockLot:
    ...
    def __post_init__(self) -> None:
        ...
        if self.dlc < self.received_date:
            raise ValueError("La DLC ne peut pas être antérieure à la date de réception")
...
class StockManager:
    ...
    def consume_ingredient(self, ingredient_id: str, quantity: Decimal) -> List[StockLot]:
        """
        ...
        if quantity > available:
            raise ValueError(f"Stock insuffisant pour {ingredient_id}: {quantity} demandé, {available} disponible")

...
class AchievementManager:
    ...
    def _load_achievements(self) -> None:
        ...
        achievements_data = [
            ...
            
            {
                ...
                "points": 40,
                "icon": "⚡",
                "condition": lambda data: data.get("clients_served", 0) >= 200 and data.get("staff_level", 3) <= 2
            },
            ...
            
            {
                ...
                "points": 30,
                "icon": "⚔️",
                "condition": lambda data: data.get("lowest_price", False) and data.get("profit", 0) > 0
            },
            
            {
                ...
                "points": 35,
                "icon": "💎",
                "condition": lambda data: data.get("highest_price", False) and data.get("profit", 0) > 0
            },
            ...
            # Achievements spéciaux
            {
                ...
                "points": 55,
                "icon": "🛡️",
                "condition": lambda data: data.get("consecutive_negative_events", 0) >= 3
            },
            
            {
                ...
                "points": 75,
                "icon": "🔥",
                "condition": lambda data: data.get("previous_profit", 0) < 0 and data.get("profit", 0) >= 1000
            },
            
            {
                ...
                "points": 150,
                "icon": "🏅",
                "condition": lambda data: data.get("game_completed", False) and data.get("min_profit", 0) >= 0,
                "hidden": True
            },
            
            {
                ...
                "points": 200,
                "icon": "🚀",
                "condition": lambda data: data.get("total_revenue", 0) >= 1000000 and data.get("turn", 11) <= 10,
                "hidden": True
            }
        ]
    ...
    def get_achievement_progress(self) -> Dict[str, Any]:
        ...
        for rarity in AchievementRarity:
            rarity_achievements = [a for a in self.achievements.values() if a.rarity == rarity]
    ...
    def get_available_achievements(self, include_hidden: bool = False) -> List[Achievement]:
    ...
    def get_leaderboard_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "completion_rate": len(self.unlocked_achievements) / len(self.achievements) * 100,
            "rare_achievements": len([
                a for a in self.get_unlocked_achievements() 
                if a.rarity in [AchievementRarity.RARE, AchievementRarity.EPIC, AchievementRarity.LEGENDARY]
            ])
        }

...
class Ingredient:
    ...
    def __post_init__(self) -> None:
        ...
        if self.shelf_life_days <= 0:
            raise ValueError(f"La durée de conservation doit être positive: {self.shelf_life_days}")
    ...
    def convert_quantity(self, quantity: Decimal, from_unit: str, to_unit: str) -> Decimal:
        """
        ...
        raise ValueError(f"Conversion impossible de {from_unit} vers {to_unit} pour {self.name}")

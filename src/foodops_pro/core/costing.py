...
class RecipeCostCalculator:
    ...
    def calculate_recipe_cost(self, recipe: Recipe, 
        ...
        for item in recipe.items:
            ...
            unit_cost = self._get_ingredient_cost(ingredient, stock_lots, effective_quantity)
    ...
    def _get_ingredient_cost(self, ingredient: Ingredient, 
                           stock_lots: Optional[List[StockLot]], 
                           quantity_needed: Decimal) -> Decimal:
        """
    ...
    def _get_best_supplier(self, ingredient: Ingredient, 
                          stock_lots: Optional[List[StockLot]]) -> str:
        """
    ...
    def calculate_margin_analysis(self, recipe: Recipe, selling_price_ttc: Decimal,
                                ...
                                stock_lots: Optional[List[StockLot]] = None) -> Dict[str, Decimal]:
        """
        ...
        return {
            ...
            'labor_cost_per_portion': cost_breakdown.preparation_time_cost / recipe.portions
        }
    
    def optimize_recipe_cost(self, recipe: Recipe, 
                           target_food_cost_percentage: Decimal = Decimal("30")) -> Dict[str, Decimal]:
        """
        ...
        sorted_costs = sorted(cost_breakdown.ingredient_costs, 
                            key=lambda x: x.total_cost_ht, reverse=True)
        
        optimization_suggestions = {}
        
        for i, ingredient_cost in enumerate(sorted_costs[:3]):  # Top 3 des plus coûteux
            percentage_of_total = (ingredient_cost.total_cost_ht / cost_breakdown.total_cost_ht * 100)
            ...
            optimization_suggestions[f"ingredient_{i+1}"] = {
                ...
                'reduction_potential': ingredient_cost.total_cost_ht * Decimal("0.1")  # 10% de réduction potentielle
            }

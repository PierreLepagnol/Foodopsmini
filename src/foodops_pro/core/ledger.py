...
class VATCalculator:
    ...
    @staticmethod
    def calculate_vat_amounts(amount_ht: Decimal, vat_rate: Decimal) -> Dict[str, Decimal]:
        """
    ...
    @staticmethod
    def extract_vat_from_ttc(amount_ttc: Decimal, vat_rate: Decimal) -> Dict[str, Decimal]:
        """
...
class Ledger:
    ...
    def _initialize_chart_of_accounts(self) -> None:
        ...
        self.accounts["215"] = Account("215", "Installations techniques", AccountType.ASSET)
        self.accounts["281"] = Account("281", "Amortissements installations", AccountType.ASSET)
        ...
        # 411 Clients est un compte d'actif (créances clients)
        self.accounts["411"] = Account("411", "Clients", AccountType.ASSET)
        ...
        self.accounts["44571"] = Account("44571", "TVA collectée", AccountType.LIABILITY)
        
        # Comptes de charges (classe 6)
        self.accounts["601"] = Account("601", "Achats matières premières", AccountType.EXPENSE)
        self.accounts["613"] = Account("613", "Loyers", AccountType.EXPENSE)
        self.accounts["621"] = Account("621", "Personnel extérieur", AccountType.EXPENSE)
        self.accounts["641"] = Account("641", "Rémunérations du personnel", AccountType.EXPENSE)
        self.accounts["645"] = Account("645", "Charges de sécurité sociale", AccountType.EXPENSE)
        self.accounts["681"] = Account("681", "Dotations aux amortissements", AccountType.EXPENSE)
        
        # Comptes de produits (classe 7)
        self.accounts["701"] = Account("701", "Ventes de marchandises", AccountType.REVENUE)
        self.accounts["706"] = Account("706", "Prestations de services", AccountType.REVENUE)
    ...
    def record_sale(self, amount_ttc: Decimal, vat_rate: Decimal, 
                   sale_date: date, description: str = "Vente") -> None:
        """
        ...
        self.add_entry(AccountingEntry(
            date=sale_date,
    ...
    def record_purchase(self, amount_ht: Decimal, vat_rate: Decimal,
                       purchase_date: date, description: str = "Achat") -> None:
        """
    ...
    def record_payroll(self, gross_salary: Decimal, social_charges: Decimal,
                      payroll_date: date, description: str = "Paie") -> None:
        """
    ...
    def record_cash_payment(self, amount: Decimal, expense_account: str,
                           payment_date: date, description: str) -> None:
        """
    ...
    def get_balance(self, account_number: str) -> Decimal:
        ...
        return self.accounts.get(account_number, Account("", "", AccountType.ASSET)).balance

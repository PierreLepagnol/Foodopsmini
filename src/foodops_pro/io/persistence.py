...
class GameStatePersistence:
    ...
    def save_game(self, game_state: GameState) -> Path:
        ...
        with open(filepath, 'w', encoding='utf-8') as file:
            json.dump(game_state.to_dict(), file, 
                     cls=DecimalEncoder, indent=2, ensure_ascii=False)
    ...
    def create_game_state(self, scenario: Scenario, 
                         players: List[Restaurant],
                         ai_competitors: List[Restaurant] = None) -> GameState:
        """
    ...
    def update_turn_history(self, game_state: GameState, 
                           turn_results: Dict) -> None:
        """
    ...
    def export_game_summary(self, game_state: GameState, 
        ...
        with open(output_path, 'w', encoding='utf-8') as file:
            json.dump(summary, file, cls=DecimalEncoder, 

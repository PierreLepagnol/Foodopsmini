...
def launch_in_new_console(command, title="FoodOps Pro"):
    ...
    try:
        if sys.platform == "win32":
            ...
            subprocess.Popen(['gnome-terminal', '--', 'bash', '-c', f'cd {Path.cwd()} && {command}; read'])
    ...
    while True:
        ...
        try:
            ...
            if choice == "0":
                ...
                launch_in_new_console("python start_pro.py", "FoodOps Pro - Version Complète")
                
            elif choice == "2":
                print("\n👨‍🏫 Lancement du Mode Administrateur...")
                launch_in_new_console("python start_admin.py", "FoodOps Pro - Mode Admin")
                ...
                launch_in_new_console("python -m src.foodops_pro.cli", "FoodOps Pro - Classique")
                ...
                if demo_choice == "a":
                    launch_in_new_console("python demo.py", "FoodOps Pro - Démo Classique")
                elif demo_choice == "b":
                    launch_in_new_console("python demo_pro.py", "FoodOps Pro - Démo Pro")
                else:

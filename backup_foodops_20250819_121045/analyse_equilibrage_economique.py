...
def calculate_realistic_costs():
    ...
    monthly_costs = {
        ...
        "classic": {
            ...
            "insurance": 400,
            "other_fixed": 600,
            "staff_monthly": {1: 4500, 2: 8000, 3: 11500},
        },
    }
    ...
    for resto_type, costs in realistic_costs.items():
        ...
        print(
            f"  (Équivalent mensuel: {costs['total_monthly_fixed']}€ + {costs['total_monthly_staff'][2]}€)"
        )
...
def test_realistic_simulation():
    ...
    for resto_type, costs in realistic_costs.items():
        ...
        for clients in volumes:
            ...
            print(
                f"{clients:7} | {ca:5.0f} | {cogs:4.0f} | {staff:5.0f} | {fixed:5.0f} | {total_costs:5.0f} | {profit:6.0f} | {margin:5.1f}% {status}"
            )
